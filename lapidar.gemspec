...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Carve it in stone. Only that these stones are easy to move across the internet.
This is a multi purpose blockchain on which you can build some custom business logic.}
  spec.description   = %q{This is a custom blockchain with a working network layer. It just mines and receives blocks
